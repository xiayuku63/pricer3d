...
def upgrade() -> None:
    ...
    if table_exists("users"):
        with op.batch_alter_table("users", schema=None) as batch_op:
            batch_op.alter_column("created_at", existing_type=sa.String(),
                                  type_=sa.DateTime(timezone=True),
                                  existing_nullable=False)
            batch_op.alter_column("membership_expires_at", existing_type=sa.String(),
                                  type_=sa.Float(),
                                  existing_nullable=True)
            batch_op.alter_column("terms_accepted_at", existing_type=sa.String(),
                                  type_=sa.DateTime(timezone=True),
                                  existing_nullable=True)
            batch_op.alter_column("privacy_accepted_at", existing_type=sa.String(),
                                  type_=sa.DateTime(timezone=True),
                                  existing_nullable=True)
    ...
    if table_exists("verification_codes"):
        with op.batch_alter_table("verification_codes", schema=None) as batch_op:
            batch_op.alter_column("expires_at", existing_type=sa.String(),
                                  type_=sa.Float(),
                                  existing_nullable=False)
            batch_op.alter_column("created_at", existing_type=sa.String(),
                                  type_=sa.DateTime(timezone=True),
                                  existing_nullable=False)
            batch_op.alter_column("used_at", existing_type=sa.String(),
                                  type_=sa.DateTime(timezone=True),
                                  existing_nullable=True)
    ...
    if table_exists("payment_orders"):
        with op.batch_alter_table("payment_orders", schema=None) as batch_op:
            batch_op.alter_column("created_at", existing_type=sa.String(),
                                  type_=sa.DateTime(timezone=True),
                                  existing_nullable=True)
            batch_op.alter_column("paid_at", existing_type=sa.String(),
                                  type_=sa.DateTime(timezone=True),
                                  existing_nullable=True)
    ...
    if table_exists("login_failures"):
        with op.batch_alter_table("login_failures", schema=None) as batch_op:
            batch_op.alter_column("created_at", existing_type=sa.String(),
                                  type_=sa.Float(),
                                  existing_nullable=True)
            batch_op.alter_column("first_failed_at", existing_type=sa.String(),
                                  type_=sa.Float(),
                                  existing_nullable=True)
            batch_op.alter_column("last_failed_at", existing_type=sa.String(),
                                  type_=sa.Float(),
                                  existing_nullable=True)
            batch_op.alter_column("locked_until", existing_type=sa.String(),
                                  type_=sa.Float(),
                                  existing_nullable=True)
    ...
    if table_exists("app_defaults"):
        with op.batch_alter_table("app_defaults", schema=None) as batch_op:
            batch_op.alter_column("updated_at", existing_type=sa.String(),
                                  type_=sa.DateTime(timezone=True),
                                  existing_nullable=True)
    ...
    if table_exists("todos"):
        with op.batch_alter_table("todos", schema=None) as batch_op:
            batch_op.alter_column("due_date", existing_type=sa.String(),
                                  type_=sa.DateTime(timezone=True),
                                  existing_nullable=True)
            batch_op.alter_column("created_at", existing_type=sa.String(),
                                  type_=sa.DateTime(timezone=True),
...
def downgrade() -> None:
    ...
    tables_and_cols = {
        "users": [("created_at", False), ("membership_expires_at", True),
        ...
        "login_failures": [("created_at", True), ("first_failed_at", True),
                           ("last_failed_at", True), ("locked_until", True)],
