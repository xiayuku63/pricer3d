export function collectAppDomRefs() {
    ...
    const dom = {
        ...
        paymentModal: $('payment-modal'), paymentBackdrop: $('payment-backdrop'),
        paymentCloseBtn: $('payment-close-btn'), paymentCancelBtn: $('payment-cancel-btn'),
        paymentPayBtn: $('payment-pay-btn'), paymentOrderNo: $('payment-order-no'),
        paymentMsg: $('payment-msg'),
        adminUsersModal: $('admin-users-modal'), adminUsersBackdrop: $('admin-users-backdrop'),
        adminUsersCloseBtn: $('admin-users-close-btn'),
