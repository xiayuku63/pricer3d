...
export default {
  ...
  'auth.noFileSelected': 'No file selected (model files <20MB, ZIP <1GB)',

  // ── Quote ──
  'quote.title': 'Quote',
  'quote.uploadZone': 'Drag & drop files here or click to upload',
  'quote.uploadHint': 'Supports STL / STP / STEP / 3MF, max 20MB; ZIP max 1GB',
  ...
  'quote.noFileSelected': 'No file selected (model files <20MB, ZIP <1GB)',
  ...
  'quote.uploadModels': 'Upload 3D models (stl/stp/step/obj/3mf <20MB, ZIP <1GB per file)',
